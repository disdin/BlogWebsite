  ...
  return (
    <Box>
      ...
      <Box className={classes.wrapper}>
        <Typography variant="h3">Sidhant Bahri</Typography>
        ...
        <Typography variant="h5" className={classes.text}>
          ...
          <nbsp />
          <Link
            href="https://www.instagram.com/sidhant.bahri/"
            color="inherit"
            target="_blank"
          >
            <Instagram />
          ...
          <Link
            href="mailto:sidhantbahri01@gmail.com?Subject=This is a subject"
            target="_blank"
            color="inherit"
          >
            <Email />
